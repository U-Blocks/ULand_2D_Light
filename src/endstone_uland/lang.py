    ...
    if not os.path.exists(zh_CN_data_file_path):
        with open(zh_CN_data_file_path, 'w', encoding='utf-8') as f:
            zh_CN = {
                ...
                'is_land_public': '公开领地',
                'can_thunder_spawn': '闪电是否能在此领地内生成?',
                'can_explosion_spawn': '爆炸是否能在此领地内生成?',
                'can_stranger_place_block': '陌生人是否能在此领地内放置方块?',
                'can_stranger_break_block': '陌生人是否能在此领地内破坏方块?',
                'can_stranger_left_click_block': '陌生人是否能此领地内左键方块?',
                'can_stranger_right_click_block': '陌生人是否能在此领地内右键方块?',
                'can_stranger_right_click_entity': '陌生人是否能在此领地内右键实体?',
                'can_stranger_damage_player_or_entity': '陌生人是否能在此领地内伤害玩家或实体?',
                'can_fire_damage_player_or_entity': '火焰是否能在此领地内伤害玩家或实体?',
                'can_poison_effect_applied_to_player_or_entity': '中毒效果是否能在此领地内被施加到玩家或实体上?',
                'can_wither_effect_applied_to_player_or_entity': '凋零效果是否能在此领地内被施加到玩家或实体上?',
    ...
    if not os.path.exists(en_US_data_file_path):
        with open(en_US_data_file_path, 'w', encoding='utf-8') as f:
            en_US = {
                ...
                'can_stranger_place_block': 'Can strangers place blocks in this land?',
                'can_stranger_break_block': 'Can strangers break blocks in this land?',
                'can_stranger_left_click_block': 'Can strangers left click blocks in this land?',
                'can_stranger_right_click_block': 'Can strangers right click blocks in this land?',
                'can_stranger_right_click_entity': 'Can strangers right click entities in this land?',
                'can_stranger_damage_player_or_entity': 'Can strangers to damage players or entities in this land?',
                'can_fire_damage_player_or_entity': 'Can fire damage players or entities in this land?',
                'can_poison_effect_applied_to_player_or_entity': 'Can poison effect be applied to players or entities in this land?',
                'can_wither_effect_applied_to_player_or_entity': 'Can wither effect be applied to players or entities in this land?',
